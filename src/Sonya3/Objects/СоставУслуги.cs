...
namespace IIS.Sonya3
{
    ...
    [View("СоставУслугиE", new string[] {
            ...
            "Услуги.Наименование"})]
    [MasterViewDefineAttribute("СоставУслугиE", "Услуги", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Наименование")]
    public class СоставУслуги : ICSSoft.STORMNET.DataObject
    {
        
        private int fКоличество;
        
        private IIS.Sonya3.Услуги fУслуги;
        
        private IIS.Sonya3.ПриходДенег fПриходДенег;
        ...
        [PropertyStorage(new string[] {
                "Услуги"})]
        [NotNull()]
        public virtual IIS.Sonya3.Услуги Услуги
        {
            get
            {
                ...
                IIS.Sonya3.Услуги result = this.fУслуги;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Sonya3.ПриходДенег.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПриходДенег"})]
        public virtual IIS.Sonya3.ПриходДенег ПриходДенег
        {
            get
            {
                ...
                IIS.Sonya3.ПриходДенег result = this.fПриходДенег;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СоставУслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СоставУслугиE", typeof(IIS.Sonya3.СоставУслуги));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСоставУслуги : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Sonya3.DetailArrayOfСоставУслуги members)

        // *** End programmer edit section *** (IIS.Sonya3.DetailArrayOfСоставУслуги members)
        ...
        /// </summary>
        public DetailArrayOfСоставУслуги(IIS.Sonya3.ПриходДенег fПриходДенег) : 
                base(typeof(СоставУслуги), ((ICSSoft.STORMNET.DataObject)(fПриходДенег)))
        {
        }
        
        public IIS.Sonya3.СоставУслуги this[int index]
        {
            get
            {
                return ((IIS.Sonya3.СоставУслуги)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Sonya3.СоставУслуги dataobject)
        {
