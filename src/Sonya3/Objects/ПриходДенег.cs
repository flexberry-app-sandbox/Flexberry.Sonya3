...
namespace IIS.Sonya3
{
    ...
    public class ПриходДенег : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sonya3.ТипПрихода fТипПрихода;
        
        private int fСумма;
        
        private IIS.Sonya3.Клиенты fКлиенты;
        
        private IIS.Sonya3.DetailArrayOfСоставТовары fСоставТовары;
        
        private IIS.Sonya3.DetailArrayOfСоставУслуги fСоставУслуги;
        ...
        public virtual IIS.Sonya3.ТипПрихода ТипПрихода
        {
            get
            {
                ...
                IIS.Sonya3.ТипПрихода result = this.fТипПрихода;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Sonya3.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Sonya3.Клиенты result = this.fКлиенты;
        ...
        public virtual IIS.Sonya3.DetailArrayOfСоставТовары СоставТовары
        {
            get
            {
                ...
                {
                    this.fСоставТовары = new IIS.Sonya3.DetailArrayOfСоставТовары(this);
                }
                IIS.Sonya3.DetailArrayOfСоставТовары result = this.fСоставТовары;
        ...
        public virtual IIS.Sonya3.DetailArrayOfСоставУслуги СоставУслуги
        {
            get
            {
                ...
                {
                    this.fСоставУслуги = new IIS.Sonya3.DetailArrayOfСоставУслуги(this);
                }
                IIS.Sonya3.DetailArrayOfСоставУслуги result = this.fСоставУслуги;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПриходДенегE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПриходДенегE", typeof(IIS.Sonya3.ПриходДенег));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПриходДенегL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПриходДенегL", typeof(IIS.Sonya3.ПриходДенег));
                }
            }
        }
    }
