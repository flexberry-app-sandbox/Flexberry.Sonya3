...
namespace IIS.Sonya3
{
    ...
    public class РасходДенег : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Sonya3.Поставщики fПоставщики;
        
        private IIS.Sonya3.DetailArrayOfСоставМатериалы fСоставМатериалы;
        ...
        public virtual IIS.Sonya3.Банк Банк
        {
            get
            {
                ...
                IIS.Sonya3.Банк result = this.fБанк;
        ...
        [PropertyStorage(new string[] {
                "Поставщики"})]
        [NotNull()]
        public virtual IIS.Sonya3.Поставщики Поставщики
        {
            get
            {
                ...
                IIS.Sonya3.Поставщики result = this.fПоставщики;
        ...
        public virtual IIS.Sonya3.DetailArrayOfСоставМатериалы СоставМатериалы
        {
            get
            {
                ...
                {
                    this.fСоставМатериалы = new IIS.Sonya3.DetailArrayOfСоставМатериалы(this);
                }
                IIS.Sonya3.DetailArrayOfСоставМатериалы result = this.fСоставМатериалы;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасходДенегE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасходДенегE", typeof(IIS.Sonya3.РасходДенег));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасходДенегL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасходДенегL", typeof(IIS.Sonya3.РасходДенег));
                }
            }
        }
    }
